...
def dis_activity_oracle(date):
    ...
    if version != '':
        ...
        dis_activity_oracle_one(act_start_short,act_end_short,act_start_time,act_end_time)
    else:
        print '{0} 没有神域活动'.format(date)

def dis_activity_oracle_one(act_start_short,act_end_short,act_start_time,act_end_time):
    active_sql = '''
