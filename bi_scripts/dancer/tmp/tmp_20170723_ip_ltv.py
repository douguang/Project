...
'''
Author      : Hu Chunlong
Description : 注册用户LTV，武娘多语言，分国家ip的ltv
'''
...
ltv_days = [1, 2, 3, 4, 5, 6, 7, 14, 30, 60]
...
def dis_ip_country_ltv(date):
    ...
    FROM
      ( SELECT regist_time,
       ...
       FROM mid_info_all
       WHERE ds = '{date}'
         AND to_date(regist_time) >= '2017-06-29'
...
if __name__ == '__main__':
    for platform in ['dancer_mul']:
        ...
        result.to_excel(r'E:\Data\output\dancer\ip_ltv.xlsx', encoding='utf8')
