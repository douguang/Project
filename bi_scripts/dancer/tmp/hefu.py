...
if __name__ == '__main__':
    ...
    # 获取合服数据
    server_list_df = pd.read_excel(
        r'/Users/kaiqigu/Documents/Excel/dancer_pub_server.xlsx')
    ...
    for server in set(server_result_one.server.tolist()):
        ...
        avg_combat = df.groupby('server').sum().reset_index().combat / 10.0
        df['avg_combat'] = avg_combat.loc[0]
        dfs.append(df)
