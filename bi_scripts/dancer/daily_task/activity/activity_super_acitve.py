...
def data_reduce():
    ...
    data_sql = '''
        select ds,user_id,server,account,a_typ,a_rst,log_t from parse_actionlog where ds>='20180206' and a_typ like 'super_active%' 
    '''
    print data_sql
...
if __name__ == '__main__':
    ...
    for platform in ['dancer_cgame',]:
        ...
        result = data_reduce()
        result.to_excel(r'/Users/kaiqigu/Documents/Dancer/武娘-cagme-武道会_20180224.xlsx', index=False)
    print "end"