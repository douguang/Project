...
def data_reduce():
    ...
    data_sql = '''
        select ds,user_id,server,account,a_typ,a_rst,log_t from parse_actionlog where ds>='20180215' and ds<='20180216' and a_typ like 'contest_zhaoqin%' and a_typ <> 'contest_zhaoqin.index'
    '''
    print data_sql
...
if __name__ == '__main__':
    ...
    for platform in ['dancer_cgame',]:
        ...
        result = data_reduce()
        result.to_excel(r'/Users/kaiqigu/Documents/Dancer/武娘-cagme-比武招亲_20180224.xlsx', index=False)
    print "end"