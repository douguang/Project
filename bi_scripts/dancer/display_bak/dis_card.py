...
career_dic = {num: 'career_%d' % num for num in range(16)}  # 卡牌飞升
...
def dis_card(date):
    ...
    # 补缺失数据
    for i in ['career_%d' % num for num in range(16)]:
    ...
    career_column = ['ds', 'vip_level', 'card_id', 'card_name',
                     ...
                     ] + ['career_%d' % num for num in range(16)]
    card_career_table = 'dis_card_career_dancer_bak'
    ...
    card_evo_table = 'dis_card_evo_dancer_bak'
