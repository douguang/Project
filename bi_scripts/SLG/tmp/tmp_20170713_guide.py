...
def tmp_20170713_guide(date):

    guide_sql = '''
        select uid, account, guide_nodes from parse_info where ds>='{0}' and uid in (
        '1000000245',
        '1000000251',
        '1000000135',
        '1000000121',
    ...
    result = pd.DataFrame({'uid': uid, 'account': account, 'guide': guide})
    return result


if __name__ == '__main__':
    settings_dev.set_env('SLG_test')
    result = tmp_20170713_guide('20170713')
    # print result.head(10)
    result.to_excel(r'E:\Data\output\SLG\guide.xlsx')
