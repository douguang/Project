...
# 下载配置的url
url = 'http://th.jjws.hi365.com/gloryroad_th'
# 代码目录
code_dir = 'sanguo'
# 开服时间
start_date = datetime.date(2017, 01, 03)
# 27上数据的根目录
local_data_dir = '/home/data/sanguo_tl'

# 原始表在27上的路径
raw_table_path = {
    'raw_nginx': '/home/data/sanguo_tl/nginx_log/access.log_{date}',
    'raw_actionlog': '/home/data/sanguo_tl/action_log/action_log_{date}',
    'raw_activeuser': '/home/data/sanguo_tl/active_user/act_{date}',
    'raw_citynum': '/home/data/sanguo_tl/city_num/city_num_{date}',
    'raw_honorrank': '/home/data/sanguo_tl/honor_rank/honor_rank_{date}',
    'raw_info': '/home/data/sanguo_tl/redis_stats/info_{date}',
    'raw_paylog': '/home/data/sanguo_tl/paylog/paylog_{date}',
    'raw_registeruser': '/home/data/sanguo_tl/new_user/reg_{date}',
    'raw_spendlog': '/home/data/sanguo_tl/spendlog/spendlog_{date}',
    'raw_association': '/home/data/sanguo_tl/redis_stats/all_association_{date}',
    'raw_voided_data': '/home/data/sanguo_tl/voided_orders/voided_data_{date}',
    'raw_sdk_nginx': '/home/data/sanguo_tl/sdk_tw_nginx_log/app.tw.hi365.com.access.log_{date}',
}
...
job_deps = {
    ...
    'dis_appid_ltv': ['mid_info_all', 'raw_paylog'],
    ...
    'dis_vioded_orders': ['parse_voided_data', 'parse_sdk_nginx',],
    'dis_country_language_ltv': ['mid_info_all', 'raw_paylog',],
