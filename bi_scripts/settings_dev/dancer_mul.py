...
# 版本
code = 'dancer_mul'
start_date = datetime.date(2017, 06, 29)
local_data_dir = '/home/data/dancer_mul/'

raw_table_path = {
    'raw_nginx': '/home/data/dancer_mul/nginx_log/access.log_{date}',
    'raw_info': '/home/data/dancer_mul/redis_stats/info_{date}',
    'raw_paylog': '/home/data/dancer_mul/paylog/paylog_{date}',
    'raw_spendlog': '/home/data/dancer_mul/spendlog/spendlog_{date}',
    'raw_actionlog': '/home/data/dancer_mul/action_log/action_log_{date}',
    'raw_association':
    '/home/data/dancer_mul/all_association_info/all_association_{date}',
    'raw_voided_data':
    '/home/data/dancer_mul/voided_orders/voided_data_{date}',
    'raw_sdk_nginx':
    '/home/data/dancer_mul/sdk_tw_nginx_log/app.tw.hi365.com.access.log_{date}',
}
