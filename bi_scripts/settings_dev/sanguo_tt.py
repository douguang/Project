...
@File    : sanguo_tt.py
@Software: PyCharm
Description :   机甲无双-TT版
'''

import datetime

# 下载配置的url
url = 'http://enter.cntt.hi365.com/gloryroad_tt'
# http://enter.cntt.hi365.com/gloryroad_tt/admin/index/
# 代码目录
code_dir = 'sanguo'
# 开服时间
start_date = datetime.date(2017, 4, 07)
# 27上数据的根目录
local_data_dir = '/home/data/sanguo_tt'

# 原始表在27上的路径
raw_table_path = {
    'raw_nginx': '/home/data/sanguo_tt/nginx_log/access.log_{date}',
    'raw_actionlog': '/home/data/sanguo_tt/action_log/action_log_{date}',
    'raw_activeuser': '/home/data/sanguo_tt/active_user/act_{date}',
    'raw_citynum': '/home/data/sanguo_tt/city_num/city_num_{date}',
    'raw_honorrank': '/home/data/sanguo_tt/honor_rank/honor_rank_{date}',
    'raw_info': '/home/data/sanguo_tt/redis_stats/info_{date}',
    'raw_paylog': '/home/data/sanguo_tt/paylog/paylog_{date}',
    'raw_registeruser': '/home/data/sanguo_tt/new_user/reg_{date}',
    'raw_spendlog': '/home/data/sanguo_tt/spendlog/spendlog_{date}',
    'raw_association': '/home/data/sanguo_tt/redis_stats/all_association_{date}',
}
