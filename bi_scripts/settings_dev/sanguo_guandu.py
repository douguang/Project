...
@site:  
@software: PyCharm 
@file: sanguo_guandu.py 
@time: 2018/4/25 14:29 
"""

import datetime

# 下载配置的url
url = 'http://jjws.fulipingtai.com/gloryroad_gd/'
# 代码目录
code_dir = 'sanguo'
# 开服时间
start_date = datetime.date(2018, 4, 27)
# 27上数据的根目录
local_data_dir = '/home/data/sanguo_guandu'

# 原始表在27上的路径
raw_table_path = {
    'raw_nginx': '/home/data/sanguo_guandu/nginx_log/access.log_{date}',
    'raw_actionlog': '/home/data/sanguo_guandu/action_log/action_log_{date}',
    'raw_activeuser': '/home/data/sanguo_guandu/active_user/act_{date}',
    'raw_citynum': '/home/data/sanguo_guandu/city_num/city_num_{date}',
    'raw_honorrank': '/home/data/sanguo_guandu/honor_rank/honor_rank_{date}',
    'raw_info': '/home/data/sanguo_guandu/redis_stats/info_{date}',
    'raw_paylog': '/home/data/sanguo_guandu/paylog/paylog_{date}',
    'raw_registeruser': '/home/data/sanguo_guandu/new_user/reg_{date}',
    'raw_spendlog': '/home/data/sanguo_guandu/spendlog/spendlog_{date}',
    'raw_association': '/home/data/sanguo_guandu/redis_stats/all_association_{date}',
}
