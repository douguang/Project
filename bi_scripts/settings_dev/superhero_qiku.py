...
url = 'http://182.254.170.143/q1'
# 代码目录
code_dir = 'superhero'
# 代码目录
code = 'superhero_qiku'

start_date = datetime.date(2014, 8, 29)

local_data_dir = '/home/data/superhero_qiku/'
remote_data_dir = 'admin@182.254.166.54:/data/admin/superhero/data/'
raw_table_path = {
    'raw_action_log':
    '/home/data/superhero_qiku/log_temp/qq_action_log_{date}',
    'raw_act': '/home/data/superhero_qiku/active_user/act_{date}',
    'raw_info': '/home/data/superhero_qiku/redis_stats/info_{date}',
    'raw_paylog': '/home/data/superhero_qiku/paylog/paylog_{date}',
    'raw_spendlog': '/home/data/superhero_qiku/spendlog/spendlog_{date}',
    'raw_reg': '/home/data/superhero_qiku//new_user/reg_{date}',
    'raw_card': '/home/data/superhero_qiku/redis_stats/card_{date}',
    'raw_equip': '/home/data/superhero_qiku/redis_stats/equip_{date}',
    'raw_item': '/home/data/superhero_qiku/redis_stats/item_{date}',
    'raw_pet': '/home/data/superhero_qiku/redis_stats/pet_{date}',
    'raw_super_step':
    '/home/data/superhero_qiku/redis_stats/card_super_step_{date}',
    'raw_scores': '/home/data/superhero_qiku/redis_stats/all_scores_{date}',
    'raw_talisman': '/home/data/superhero_qiku/redis_stats/talisman_{date}',
    'raw_nginx': '/home/data/superhero_qiku/nginx_log/access.log_{date}',
}
