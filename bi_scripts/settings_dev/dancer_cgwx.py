...
import datetime
# 下载配置的url
url = 'http://120.92.117.20/dancer_cgwx'
# 代码目录
code_dir = 'dancer'
...
start_date = datetime.date(2018, 8, 22)

local_data_dir = '/home/data/dancer_cgwx/'
remote_data_dir = 'admin@120.92.21.179:/data/'
raw_table_path = {
    'raw_nginx': '/home/data/dancer_cgwx/nginx_log/access.log_{date}',
    'raw_actionlog': '/home/data/dancer_cgwx/action_log/action_log_{date}',
    'raw_info': '/home/data/dancer_cgwx/redis_stats/info_{date}',
    'raw_paylog': '/home/data/dancer_cgwx/paylog/paylog_{date}',
    'raw_spendlog': '/home/data/dancer_cgwx/spendlog/spendlog_{date}',
    'raw_association':
    '/home/data/dancer_cgwx/all_association_info/all_association_{date}',
}
