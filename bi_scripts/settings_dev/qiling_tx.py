...
# 下载配置的url
url = 'http://123.207.139.137/gloryroad_qt'
# 代码目录
code_dir = 'qiling'
# 开服时间
start_date = datetime.date(2016, 12, 29)
# 27上数据的根目录
local_data_dir = '/home/data/qiling_tx'

# 原始表在27上的路径
raw_table_path = {
    'raw_actionlog': '/home/data/qiling_tx/action_log/action_log_{date}',
    'raw_activeuser': '/home/data/qiling_tx/active_user/act_{date}',
    'raw_citynum': '/home/data/qiling_tx/city_num/city_num_{date}',
    'raw_honorrank': '/home/data/qiling_tx/honor_rank/honor_rank_{date}',
    'raw_info': '/home/data/qiling_tx/redis_stats/info_{date}',
    'raw_paylog': '/home/data/qiling_tx/paylog/paylog_{date}',
    'raw_registeruser': '/home/data/qiling_tx/new_user/reg_{date}',
    'raw_spendlog': '/home/data/qiling_tx/spendlog/spendlog_{date}',
    'raw_association': '/home/data/qiling_tx/redis_stats/all_association_{date}',
    'raw_nginx': '/home/data/qiling_tx/nginx_log/access.log_{date}',
}
# 脚本依赖关系
job_deps = {
    'parse_actionlog': [],
