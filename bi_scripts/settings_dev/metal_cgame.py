...
# 下载配置的url
url = 'http://sg_cgame_cn.hi365.com/hejin_cg/admin/index/'
# 代码目录
code_dir = 'metal'
# 开服时间
start_date = datetime.date(2018, 06, 19)
# 27上数据的根目录
local_data_dir = '/home/data/metal_cgame'

# 原始表在27上的路径
raw_table_path = {
    'raw_nginx': '/home/data/metal_cgame/nginx_log/access.log_{date}',
    'raw_actionlog': '/home/data/metal_cgame/action_log/action_log_{date}',
    'raw_activeuser': '/home/data/metal_cgame/active_user/act_{date}',
    'raw_citynum': '/home/data/metal_cgame/city_num/city_num_{date}',
    'raw_honorrank': '/home/data/metal_cgame/honor_rank/honor_rank_{date}',
    'raw_info': '/home/data/metal_cgame/redis_stats/info_{date}',
    'raw_paylog': '/home/data/metal_cgame/paylog/paylog_{date}',
    'raw_registeruser': '/home/data/metal_cgame/new_user/reg_{date}',
    'raw_spendlog': '/home/data/metal_cgame/spendlog/spendlog_{date}',
    'raw_association': '/home/data/metal_cgame/redis_stats/all_association_{date}',
}
