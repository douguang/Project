...
start_date = datetime.date(2018, 07, 05)

local_data_dir = '/home/data/superhero2/'

raw_table_path = {
    'raw_action_log': '/home/data/superhero2/action_log/action_log_{date}',
    'raw_paylog': '/home/data/superhero2/paylog/paylog_{date}',
    'raw_spendlog': '/home/data/superhero2/spendlog/spendlog_{date}',
    'raw_new_user': '/home/data/superhero2/new_user/reg_{date}',
    'raw_act_user': '/home/data/superhero2/active_user/act_{date}',
    'raw_hero': '/home/data/superhero2/redis_stats/hero_{date}',
    'raw_equip': '/home/data/superhero2/redis_stats/equip_{date}',
    'raw_item': '/home/data/superhero2/redis_stats/item_{date}',
    'raw_stones': '/home/data/superhero2/redis_stats/stones_{date}',
    'raw_info': '/home/data/superhero2/redis_stats/info_{date}',
    'raw_nginx': '/home/data/superhero2/nginx_log/access.log_{date}',

    'raw_nginx_1': '/home/data/superhero2/nginx_log/superHero2_crash.log_{date}',  #新增
    # 'raw_pet': '/home/data/superhero2/redis_stats/all_pet_{date}',
    # 'raw_scores': '/home/data/superhero2/redis_stats/all_scores_{date}',
    # 'raw_vip_info': '/home/data/superhero2/redis_stats/vip_info_{date}',
    # 'raw_super_step': '/home/data/superhero2/redis_stats/card_super_step_{date}',
}
...
job_deps = {
    ...
    'dis_coins_spend_rank':['raw_spendlog', 'raw_paylog', 'parse_info'],               # 钻石消费排行
