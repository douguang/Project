...
# 下载配置的url
url = 'http://118.193.27.58/gloryroad_tw'
# 代码目录
code_dir = 'sanguo'
# 开服时间
start_date = datetime.date(2016, 5, 30)
# 27上数据的根目录
local_data_dir = '/home/data/sanguo_tw'

# 原始表在27上的路径
raw_table_path = {
    'raw_nginx': '/home/data/sanguo_tw/nginx_log/access.log_{date}',
    'raw_actionlog': '/home/data/sanguo_tw/action_log/action_log_{date}',
    'raw_activeuser': '/home/data/sanguo_tw/active_user/act_{date}',
    'raw_citynum': '/home/data/sanguo_tw/city_num/city_num_{date}',
    'raw_honorrank': '/home/data/sanguo_tw/honor_rank/honor_rank_{date}',
    'raw_info': '/home/data/sanguo_tw/redis_stats/info_{date}',
    'raw_paylog': '/home/data/sanguo_tw/paylog/paylog_{date}',
    'raw_registeruser': '/home/data/sanguo_tw/new_user/reg_{date}',
    'raw_spendlog': '/home/data/sanguo_tw/spendlog/spendlog_{date}',
    'raw_association': '/home/data/sanguo_tw/redis_stats/all_association_{date}',
}
