...
code_dir = 'metal'
# 开服时间
start_date = datetime.date(2017, 01, 29)
# 27上数据的根目录
local_data_dir = '/home/data/metal_beta'
...
raw_table_path = {
    ...
    'raw_voided_data': '/home/data/metal_beta/voided_orders/voided_data_{date}',
    'raw_sdk_nginx': '/home/data/metal_beta/sdk_tw_nginx_log/app.tw.hi365.com.access.log_{date}',
}
