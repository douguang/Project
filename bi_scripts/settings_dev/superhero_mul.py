...
# -- coding: UTF-8 --
'''
@Time : 2018/1/31 0031 16:36
@Author : Wang Fuguo
@File : superhero_mul.py.py
...
url = 'http://superen.heroesfight.pocketgamesol.com/genesis_english'
# 代码目录
code_dir = 'superhero'
# 唯一标识
code = 'superhero_mul'

start_date = datetime.date(2018, 2, 06)

local_data_dir = '/home/data/superhero_mul/'

raw_table_path = {
    'raw_action_log': '/home/data/superhero_mul/action_log/action_log_{date}',
    'raw_paylog': '/home/data/superhero_mul/paylog/paylog_{date}',
    'raw_spendlog': '/home/data/superhero_mul/spendlog/spendlog_{date}',
    'raw_reg': '/home/data/superhero_mul/new_user/reg_{date}',
    'raw_act': '/home/data/superhero_mul/active_user/act_{date}',
    'raw_card': '/home/data/superhero_mul/redis_stats/card_{date}',
    'raw_equip': '/home/data/superhero_mul/redis_stats/equip_{date}',
    'raw_item': '/home/data/superhero_mul/redis_stats/item_{date}',
    'raw_info': '/home/data/superhero_mul/redis_stats/info_{date}',
    'raw_pet': '/home/data/superhero_mul/redis_stats/pet_{date}',
    'raw_scores': '/home/data/superhero_mul/redis_stats/all_scores_{date}',
    'raw_vip_info': '/home/data/superhero_mul/redis_stats/vip_info_{date}',
    'raw_super_step': '/home/data/superhero_mul/redis_stats/card_super_step_{date}',
    'raw_talisman': '/home/data/superhero_mul/redis_stats/talisman_{date}',
    'raw_soul': '/home/data/superhero_mul/redis_stats/soul_{date}',
    'raw_nginx': '/home/data/superhero_mul/nginx_log/access.log_{date}',
}
