...
# -- coding: UTF-8 --
'''
@Time : 2018/1/24 0024 10:52
@Author : Wang Fuguo
@File : dancer_cgame.py
@Software: PyCharm Community Edition
Description :
'''
import datetime
# 下载配置的url
url = 'http://cgame.wn.hi365.com/dancer_cgame/'
# 代码目录
code_dir = 'dancer'
...
start_date = datetime.date(2018, 01, 24)

local_data_dir = '/home/data/dancer_cgame/'
remote_data_dir = ''
raw_table_path = {
    'raw_nginx': '/home/data/dancer_cgame/nginx_log/access.log_{date}',
    'raw_actionlog': '/home/data/dancer_cgame/action_log/action_log_{date}',
    'raw_info': '/home/data/dancer_cgame/redis_stats/info_{date}',
    'raw_paylog': '/home/data/dancer_cgame/paylog/paylog_{date}',
    'raw_spendlog': '/home/data/dancer_cgame/spendlog/spendlog_{date}',
    'raw_association':'/home/data/dancer_cgame/all_association_info/all_association_{date}',
}
