...
def parse_actionlog(line):
    ...
    parsed_line = '\t'.join(map(str, [user_id, server, account, coin, coin_free, coin_charge, log_t, vip_level, level, combat, food, a_typ, a_tar, FreeMoney_before, FreeMoney_after, FreeMoney_diff, Money_before, Money_after, Money_diff, return_code])) + '\n'
    return parsed_line
