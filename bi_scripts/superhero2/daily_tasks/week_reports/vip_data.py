...
def get_new_vip(date):
    ...
    print date_ago
    vip_sql = '''
    SELECT ds, vip, count(user_id) vip_num
    FROM mid_info_all
...
if __name__ == '__main__':
    ...
    for plat in plat_list:
        ...
        for date in ['20180516']:
            ...
            ivtl_result.to_csv(
                r'/Users/kaiqigu/Desktop/BI_dancer/20/{plat}_vip_ivtl_result_{date}.csv'.format(date=date,plat=plat))
            pay_result.to_csv(
                r'/Users/kaiqigu/Desktop/BI_dancer/20/{plat}_vip_pay_result_{date}.csv'.format(date=date,plat=plat))
