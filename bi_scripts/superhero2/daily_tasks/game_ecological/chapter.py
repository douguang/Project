...
select ds,user_id,a_typ,a_tar,log_t from parse_action_log where ds>='20170909' and a_typ like '%private_city.battle_end%' and user_id in (select user_id from mid_info_all where ds='20170910' and regexp_replace(substring(reg_time,1,10),'-','')='20170909' ) group by ds,user_id,a_typ,a_tar,log_t
