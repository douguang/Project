...
def result_data_info(date):
    ...
    print reg_uid_sql
    sum_money_r3_sql = sum_money_info(date,2)
    sum_money_r7_sql = sum_money_info(date,6)
    sum_money_r14_sql = sum_money_info(date,13)
    sum_money_r30_sql = sum_money_info(date,29)
    reg_uid_df,sum_money_r3_df,sum_money_r7_df, sum_money_r14_df,sum_money_r30_df = hqls_to_dfs([reg_uid_sql,sum_money_r3_sql,sum_money_r7_sql,sum_money_r14_sql,sum_money_r30_sql])
...
if __name__ == '__main__':
    ...
    result_data.to_excel('/Users/kaiqigu/Downloads/Excel/en_ltv.xlsx')
