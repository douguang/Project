...
Description : 越南参与神域玩家卡牌培养情况 - 卡牌转生状态
'''
import settings
...
#     date = '20160427'
    ...
    # date = '20160428'
    card_sql = '''
    select uid,card_id,zhuansheng from raw_card where is_fight=1 and  ds = '{0}'
    '''.format(date)
    ...
    zhuansheng0_df = have_card_df[have_card_df['zhuansheng']== 0]
    zhuansheng1_df = have_card_df[have_card_df['zhuansheng']== 1]
    zhuansheng2_df = have_card_df[have_card_df['zhuansheng']== 2]
    zhuansheng3_df = have_card_df[have_card_df['zhuansheng']== 3]
    zhuansheng4_df = have_card_df[have_card_df['zhuansheng']== 4]
    zhuansheng5_df = have_card_df[have_card_df['zhuansheng']== 5]
    zhuansheng6_df = have_card_df[have_card_df['zhuansheng']== 6]
    zhuansheng7_df = have_card_df[have_card_df['zhuansheng']== 7]
    zhuansheng0_num = zhuansheng0_df.groupby('card_id').count().reset_index()
    zhuansheng0_num['r0_num'] = zhuansheng0_num['uid']
    final_result =  final_result.merge(zhuansheng0_num,on=['card_id'],how='outer')

    zhuansheng1_num = zhuansheng1_df.groupby('card_id').count().reset_index()
    zhuansheng1_num['r1_num'] = zhuansheng1_num['uid']
    final_result =  final_result.merge(zhuansheng1_num,on=['card_id'],how='outer')

    zhuansheng2_num = zhuansheng2_df.groupby('card_id').count().reset_index()
    zhuansheng2_num['r2_num'] = zhuansheng2_num['uid']
    final_result =  final_result.merge(zhuansheng2_num,on=['card_id'],how='outer')

    zhuansheng3_num = zhuansheng3_df.groupby('card_id').count().reset_index()
    zhuansheng3_num['r3_num'] = zhuansheng3_num['uid']
    final_result =  final_result.merge(zhuansheng3_num,on=['card_id'],how='outer')

    zhuansheng4_num = zhuansheng4_df.groupby('card_id').count().reset_index()
    zhuansheng4_num['r4_num'] = zhuansheng4_num['uid']
    final_result =  final_result.merge(zhuansheng4_num,on=['card_id'],how='outer')

    zhuansheng5_num = zhuansheng5_df.groupby('card_id').count().reset_index()
    zhuansheng5_num['r5_num'] = zhuansheng5_num['uid']
    final_result =  final_result.merge(zhuansheng5_num,on=['card_id'],how='outer')

    zhuansheng6_num = zhuansheng6_df.groupby('card_id').count().reset_index()
    zhuansheng6_num['r6_num'] = zhuansheng6_num['uid']
    final_result =  final_result.merge(zhuansheng6_num,on=['card_id'],how='outer')

    zhuansheng7_num = zhuansheng7_df.groupby('card_id').count().reset_index()
    zhuansheng7_num['r7_num'] = zhuansheng7_num['uid']
    final_result =  final_result.merge(zhuansheng7_num,on=['card_id'],how='outer')
    ...
    columns = ['ds','card_id','name', 'have_num', 'fight_num', 'use_rate', 'r0_num', 'r1_num', 'r2_num', 'r3_num', 'r4_num', 'r5_num', 'r6_num','r7_num']
