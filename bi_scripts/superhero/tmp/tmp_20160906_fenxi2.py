...
info_06_df = info_df.loc[info_df.ds == '20160906']
info_07_df = info_df.loc[info_df.ds == '20160907']
info_08_df = info_df.loc[info_df.ds == '20160908']

data = not_dau_df.loc[not_dau_df.vip_level >= 5]
data['is_06'] = not_dau_df['uid'].isin(info_06_df.uid.values)
data['is_07'] = not_dau_df['uid'].isin(info_07_df.uid.values)
data['is_08'] = not_dau_df['uid'].isin(info_08_df.uid.values)
...
data.to_excel('/Users/kaiqigu/Downloads/Excel/20160905.xlsx')
