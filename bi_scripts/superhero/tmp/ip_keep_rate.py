...
Description : 分国家、渠道（ios和android）留存率
Time        : 2017.03.21
'''
import pandas as pd
import settings_dev
...
result = pd.read_table(file_path + 'log')
...
result_df.to_csv('/Users/kaiqigu/Documents/Excel/ip_keep_rate', sep = '\t', index = False, header = False)
