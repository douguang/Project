...
# -*- coding: UTF-8 -*-
'''
@Time    : 2018/2/23 0023 14:49
@Author  : Andy 
@File    : reg_on_country.py
@Software: PyCharm
Description :分国家新增
'''
import calendar
...
def data_reduce():
    ...
    result_df = dau_df.groupby(['reg_ds','country', ]).agg(
        {'uid': lambda g: g.nunique(),}).reset_index().rename(
        columns={'uid': 'reg_uid_num',})
    ...
    result_df.to_excel(r'E:\superhero-mul-country-reg_data_20180223.xlsx', index=False)
