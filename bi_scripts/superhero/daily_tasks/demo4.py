...
def data_reduce():
    info_df = pd.read_excel(r'/Users/kaiqigu/Documents/Superhero/超英-越南-箱子格式错误数据_20180307.xlsx', index=False)
...
if __name__ == '__main__':
    ...
    for platform in ['superhero_vt',]:
        ...
        result.to_excel(r'/Users/kaiqigu/Documents/Superhero/超英-越南-箱子格式错误数据解析_20180307.xlsx', index=False)
    print "end"
