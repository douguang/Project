...
@site:  
@software: PyCharm 
@file: new_server_pay_data-pub.py
@time: 17/8/21 下午3:23   account like 'cmgeapp%'
"""
...
WHERE ds >='20170701'
  ...
  AND uid in (
    select uid from mid_info_all where ds='20170820' and account not like 'cmgeapp%' group by uid
  )
GROUP BY ds,
...
result_df.to_excel('/Users/kaiqigu/Documents/Superhero/pub_new_server_pay_data.xlsx')
