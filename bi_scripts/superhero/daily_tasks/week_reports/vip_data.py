...
def get_pay_vip(date):
    ...
    vip_df = info_df.merge(pay_df, on='uid')
    # 本周VIP用户的活跃付费人数，收入
...
if __name__ == '__main__':
    ...
    for plat in plat_list:
        ...
        for date in ['20180314']:
            ...
            ivtl_result.to_csv(
                r'/Users/kaiqigu/Documents/Superhero/超英周报数据/{plat}_vip_ivtl_result_{date}.csv'.format(date=date,plat=plat))
            pay_result.to_csv(
                r'/Users/kaiqigu/Documents/Superhero/超英周报数据/{plat}_vip_pay_result_{date}.csv'.format(date=date,plat=plat))
