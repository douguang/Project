...
# 充值区间
ranges = [5, 6, 30, 50, 100, 500, 1000, 2000,
          3000, 4000, 5000, 6000, 8000, 500000]
# 台湾 - 充值区间
tw_ranges = [60, 300, 500, 1000, 5000, 10000, 20000,
             30000, 40000, 50000, 60000, 80000, 500000]
# 越南 - 充值区间
...
def dis_pay_ivtl(date):
    ...
    if settings_dev.code in ['superhero_tw', 'superhero_vt']:
        ...
        # 充值人数、充值金额
        pay_num_result = (result_df.pivot_table('pay_num', ['plat', 'vip'],
    ...
    column = ['ds', 'vip', 'rmb5_6', 'rmb6_30', 'rmb30_50', 'rmb50_100',
              'rmb100_500', 'rmb500_1000', 'rmb1000_2000', 'rmb2000_3000',
              'rmb3000_4000', 'rmb4000_5000', 'rmb5000_6000', 'rmb6000_8000',
              'rmb8000_500000']
    tw_column = ['ds', 'vip', 'rmb5_6', 'rmb6_30', 'rmb30_50', 'rmb50_100',
                 'rmb100_500', 'rmb500_1000', 'rmb1000_2000', 'rmb2000_3000',
                 'rmb3000_4000', 'rmb4000_5000', 'rmb5000_6000', 'rmb6000_8000',
                 'rmb8000_500000']
    vt_column = ['ds', 'vip_level', 'rmb99_100', 'rmb199_200',
                 'rmb300_500', 'rmb500_1500', 'rmb1500_3000',
                 'rmb3000_5000', 'rmb5000_10000', 'rmb10000_20000',
