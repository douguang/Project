...
if __name__ == '__main__':
    ...
    for date in ['20170531']:
        ...
        ivtl_result.to_excel(
            r'E:\Data\output\superhero\vip_ivtl_result_{date}.xlsx'.format(date=date))
        pay_result.to_excel(
            r'E:\Data\output\superhero\vip_pay_result_{date}.xlsx'.format(date=date))
