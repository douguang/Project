...
@site:  
@software: PyCharm 
@file: gs_tools_active_info_metal_pub.py
@time: 18/3/30 下午12:27 
"""
...
if __name__ == '__main__':
    settings_dev.set_env('metal_pub')
    date = (datetime.date.today() - datetime.timedelta(days=1)
            ).isoformat().replace('-', '')
    # print date
    # for date in date_range('20180314', '20170703'):
    #     print date
    active_info(date)
    print 'end'
