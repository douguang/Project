...
class CrimeEmpireDaily(sl.WorkflowTask):
    '''
    执行入口
    '''
    date = luigi.DateParameter(
...
class CrimeEmpireDailyRaw(sl.WorkflowTask):
    '''
    执行入口
    '''
    date = luigi.DateParameter(
...
# 临时用，之后补Mart数据
class CrimeEmpireDailyMid(sl.WorkflowTask):
    '''
    执行入口
    '''
    date = luigi.DateParameter(
...
class CrimeEmpireDailyMart(sl.WorkflowTask):
    '''
    执行入口
    '''
    date = luigi.DateParameter(
