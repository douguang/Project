...
if __name__ == '__main__':
    for platform in ['qiling_ks']:
        settings_dev.set_env(platform)
        for date in date_range('20170204', '20170205'):
            dis_reg_user_ltv(date)
    # plat_list = ['sanguo_ks', 'sanguo_tw', 'sanguo_kr', 'sanguo_in' ]
    # for platform in plat_list:
    #     settings_dev.set_env(platform)
    #     for date in date_range('20161123', '20161126'):
    #         dis_reg_user_ltv(date)
    # print "end"
